...
#
# Telnet command:
# wget -O - "https://raw.githubusercontent.com/Saiedf/TheWeatherIet5/main/VER%205.2/installer_theweatheriet5_5.2.sh" | /bin/sh
#
# Alternative command (download then run):
# wget -O /tmp/installer_theweatheriet5_5.2.sh "https://raw.githubusercontent.com/Saiedf/TheWeatherIet5/main/VER%205.2/installer_theweatheriet5_5.2.sh" && chmod 755 /tmp/installer_theweatheriet5_5.2.sh && /bin/sh /tmp/installer_theweatheriet5_5.2.sh
# ==========================================================
...
# Example: VER 5.2  =>  VER%205.2
RELEASE_DIR='VER%205.2'
...
DEB_DREAMBOX_PY2=''
DEB_DREAMBOX_PY3=''
DEB_DREAMOS_DEFAULT='enigma2-plugin-extensions-theweatheriet5_5.2_all.deb'
...
IPK_OPENSOURCE_PY2=''
IPK_OPENSOURCE_PY3=''
IPK_OPENSOURCE_DEFAULT='enigma2-plugin-extensions-theweatheriet5_5.2_all.ipk'
